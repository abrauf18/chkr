...
const PlanCard: React.FC<PlanCardProps> = ({ monthlyHeading, monthlyPrice, buttonText }) => {
    ...
    return (
        <div
            className="flex flex-col p-2 rounded-2xl w-full text-center bg-gray-200 hover:text-white hover:bg-[#212123]"
        >
            <div >
                <h3 className="font-normal text-lg mt-4 text-[#6C7275]">{monthlyHeading}</h3>
            ...
            <div className='flex justify-center items-center'>
                <Button
                    className="w-3/4 py-4 text-white font-semibold mt-10 mb-10 xl:mt-10 border border-white bg-primary rounded-3xl hover:bg-transparent"
                >
                    {buttonText}
                </Button>
            </div>
