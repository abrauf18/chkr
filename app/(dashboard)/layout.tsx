...
const RootLayout: React.FC<RootLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="grid w-full grid-cols-12 grid-rows-6 h-full">
      <nav
        className={`relative h-full w-full row-span-6 xl:px-6 lg:px-4 md:px-3 col-start-1 border-r-2 bg-black text-white ${
