...
const PlanPayment = () => {
  return (
    <div className="flex flex-col justify-center items-center my-20 md:mx-10">
      <h1 className="font-semibold lg:text-2xl md:text-3xl text-2xl text-center mx-10">
      ...
      <div className="flex flex-col md:w-[60%] w-full justify-center items-center">
        <div className="w-full md:px-8 px-4 pt-6 pb-6  gap-6">
          <RegisteredCards
            cardType="VISA"
        ...
        <div className="flex w-full items-center md:justify-end justify-center gap-6 px-4">
          <button
