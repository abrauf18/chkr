...
export default function ServiceForm({
  ...
  const {
    ...
    handleSubmit,
    setValue,
    reset, // Add reset here to reset form fields
    formState: { errors },
  } = useForm<Services>({
...
// }: {
//   isEdit?: boolean;
//   initialData?: Services; // Assuming initialData is passed when editing
//   handleSetState?: (value: boolean) => void;
// }) {
//   const [isLoading, setIsLoading] = useState(false);
...
//         result = await UpdateServiceAction(data.id, {
...
//         // Call create API if not in edit mode
//         result = await CreateServiceAction(serviceData);
//       }
