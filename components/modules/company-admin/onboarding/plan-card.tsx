    ...
    <div className="overflow-hidden w-full mx-auto mb-4">
      <div className="flex justify-between p-4">
        <div className="flex-col">
          <h3 className="md:text-lg whitespace-nowrap font-semibold mobile:text-left">
            {title}
          </h3>
        ...
        <div className="flex flex-col">
          <span className="md:text-lg whitespace-nowrap font-semibold">
            $ {price} USD
          </span>
      ...
      <div className="space-y-2 text-gray-600 p-4 mobile:text-left text-xs">
        {description}
      </div>
