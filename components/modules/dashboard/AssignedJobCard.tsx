      ...
      <div className='flex flex-wrap justify-between'>
        <div className='flex flex-col'>
          ...
          <div className='flex items-center'>
            ...
            <span className='font-semibold text-lg text-gray-700 ml-2'>{location}</span>
          </div>
        </div>
      ...
      <div className='flex mt-6 justify-between'>
        <div className="flex flex-wrap gap-4 ">
          <div className='flex flex-col text-sm lg:text-lg whitespace-nowrap'>
            ...
            <span className='bg-gray-100 rounded-2xl py-3 px-6 mt-2'>{phoneNumber}</span>
          </div>
          <div className='flex flex-col text-sm lg:text-lg whitespace-nowrap'>
            <span className='font-bold '>Date & Time:</span>
            <span className='bg-gray-100 rounded-2xl py-3 px-6 mt-2 '>{dateTime}</span>
          </div>
          <div className='flex flex-col text-sm lg:text-lg whitespace-nowrap'>
            <span className='font-bold '>Service:</span>
            <span className='bg-gray-100 rounded-2xl py-3 px-6 mt-2'>{service}</span>
          </div>
          <div className='flex flex-col text-sm lg:text-lg whitespace-nowrap'>
            <span className='font-bold'>To Pay:</span>
            <span className='bg-gray-100 rounded-2xl py-3 px-6 mt-2 '>$ {payment} USD</span>
          </div>
        </div>
        <div className='flex flex-col text-sm lg:text-lg whitespace-nowrap'>
          <span className='font-bold '>Assigned To:</span>
          <div className='flex mt-2'>
            <Image src={imageurl} alt='user-image' height={6} width={6} className='rounded-full border border-black h-10 w-10' />
