  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger
          className={`bg-gray-300 flex items-center px-4 py-2 text-gray-400 whitespace-nowrap text-sm rounded-3xl gap-1 ${
        ...
        <DialogContent className="bg-white mobile:max-w-[90%] rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-700">
              Please ensure that all tasks associated with this job have been
              satisfactorily finished before proceeding.
            </DialogDescription>
          </DialogHeader>
