...
import { Receipt, MoveUpRight, StickyNote, MoveDownRight, CircleChevronRight, MailPlus, Wallet } from 'lucide-react'
    ...
    <div className='flex flex-col lg:flex-row gap-2 my-2'>
        ...
        <div className='flex items-center xl:gap-9 gap-2 w-full'>
          ...
          <div className='flex flex-col w-[40%]'>
            <div className='flex items-baseline gap-2'>
              <h1 className='font-bold text-2xl xl:text-3xl text-gray-700 whitespace-nowrap'>$120.8K</h1>
              <p className='font-bold'>USD</p>
            </div>
            <p className='text-gray-400 text-xl whitespace-nowrap'>Total Earnings</p>
          </div>
        </div>
        <div className='flex'>
      ...
      <div className='flex flex-col w-full bg-white rounded-3xl py-8 px-6 gap-6'>
        <div className='flex items-center xl:gap-9 gap-2 w-full'>
          ...
          <div className='flex flex-col w-[40%]'>
            <div className='flex items-baseline gap-2'>
              <h1 className='font-bold text-2xl xl:text-3xl text-gray-700'>$48.32k</h1>
              <p className='font-bold'>USD</p>
            </div>
            <p className='text-gray-400 text-xl whitespace-nowrap'>Cash Withdrawal</p>
          </div>
        </div>
      ...
      <div className='flex flex-col w-full bg-white rounded-3xl py-8 px-6 gap-6'>
        <div className='flex items-center xl:gap-9 gap-2'>
          ...
          <div className='flex flex-col w-[40%]'>
            <div className='flex items-baseline gap-2'>
              <h1 className='font-bold text-2xl xl:text-3xl text-gray-700'>$11.55k</h1>
              <p className='font-bold'>USD</p>
            </div>
            <p className='text-gray-400 text-xl xl:whitespace-nowrap'>Cash in</p>
          </div>
        </div>
        <div className='flex items-center gap-1 text-green-500'>
