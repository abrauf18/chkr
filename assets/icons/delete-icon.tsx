...
const DeleteIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ ...props }) => {
  return (
    <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M19.17 23.7402H21.8299" stroke="#EA4335" stroke-width="1.5" stroke-linecap="round" />
      <path d="M12.5205 14.7369H28.4795M24.0957 14.7369L23.4905 13.4883C23.0884 12.6589 22.8873 12.2442 22.5406 11.9856C22.4637 11.9282 22.3822 11.8772 22.297 11.833C21.913 11.6338 21.4522 11.6338 20.5304 11.6338C19.5856 11.6338 19.1132 11.6338 18.7228 11.8414C18.6363 11.8874 18.5537 11.9405 18.476 12.0001C18.1252 12.2692 17.9292 12.6991 17.5373 13.5589L17.0003 14.7369" stroke="#EA4335" stroke-width="1.5" stroke-linecap="round" />
    </svg>
  )
}
